...
function sayHello(){
    ...
    let first = document.querySelector("#input-firstname").value ? document.querySelector("#input-firstname").value : "Egg";
    let last = document.querySelector("#input-lastname").value ? document.querySelector("#input-lastname").value : "cheese";
